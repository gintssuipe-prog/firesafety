...
layout() {
    ...
    this._tableMaskGfx.setDepth(-10);
    ...
    // atjaunojam DOM input pozīciju (ja ir)
    if (this._hasEntryRow && this._domNodes && this._domNodes.length && this._tableRect) {
      const rect = this._tableRect;
      const xName = rect.x + rect.w * 0.5;
      const entryY = 200 + 28;
      for (const d of this._domNodes) { try { d.setPosition(xName, entryY); } catch(e) {} }
    }
